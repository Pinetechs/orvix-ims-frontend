...
const navItems = [
  ...
  { icon: <BusinessIcon sx={{ fontSize: iconSize }} />, label: 'Companies', path: '/companies' },
  { icon: <PeopleIcon sx={{ fontSize: iconSize }} />, label: 'Users', path: '/users' },
  { icon: <AssignmentIcon sx={{ fontSize: iconSize }} />, label: 'Inventory Tasks', path: '/inventory-tasks' },
  { icon: <AssessmentIcon sx={{ fontSize: iconSize }} />, label: 'Reports', path: '/reports' },
];
