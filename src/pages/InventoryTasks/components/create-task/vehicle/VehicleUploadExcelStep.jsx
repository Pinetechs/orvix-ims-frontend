...
import { useVehicleUploadExcelStep } from '../../../hooks/create-task/vehicle/useVehicleUploadExcelStep.js';
import { getTaskNumber } from '../../../utils/inventoryTaskMappers.js';
import { StepHeader } from '../../CreateInventoryTaskDialogParts.jsx';

function VehicleUploadExcelStep({ wizard }) {
  const {
    fileInputRef,
    selectedFile,
    uploadResult,
    ...
    clearSelectedFile,
    handleFileChange,
  } = useVehicleUploadExcelStep({ wizard });
...
export default VehicleUploadExcelStep;
